package lecture22;
import java.util.*;
public class Assignment_Rat_chases_its_cheese_loop {
	...
	public static void PrintMaze(char[][] maze,int cr,int cc,int[][] ans) {
		...
		//PrintMaze(maze,cr,cc+1,ans); //down
		maze[cr][cc]='0'; //backtracking
		ans[cr][cc]=0;
	}
	public static void display(int[][] ans) { //printing path
